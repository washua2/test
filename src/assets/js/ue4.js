...
'object' != typeof ue && (ue = {}),
  (ue4 = (function (functoid) {
    'object' != typeof ue.interface &&
      (delete ue.interface, (ue.interface = {}));
    return function (key, json, cback, timeout) {
      if (
        'object' != typeof ue['$receive'] ||
        'function' != typeof ue['$receive']['asyn']
      ) {
        console.error(
          '[ue.$receive.asyn] drop message .... key' +
            key +
            ' json' +
            JSON.stringify(json),
        );
      ...
      'string' == typeof key &&
        ...
        ((timeout = cback), (cback = json), (json = null));
      var backid = functoid(cback, timeout);
      void 'string' !== typeof json
        ? ue['$receive'].asyn(key, JSON.stringify(json), backid)
        : ue['$receive'].asyn(key, json, backid);
    };
    ...
    return (
      ...
      setTimeout(
        ...
        1e3 * Math.max(2, parseInt(timeout) || 0),
      ),
      funcid
    );
  }));
